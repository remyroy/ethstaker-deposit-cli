...
def load_text(params: list[str], file_path: str = '', func: str = '', lang: str = '') -> str:
    ...
    # Find the relative path to the internationalisation file from the project directory
    last_occurence = len(file_path_list) - file_path_list[::-1].index('ethstaker_deposit')
    rel_path_list = file_path_list[last_occurence:]
